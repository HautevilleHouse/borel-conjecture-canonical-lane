...
Canonical Lane research workspace for a flagship problem in geometric topology and geometric group theory:
proving topological rigidity of aspherical manifolds through an admissible rigidity-transfer closure architecture.

## Main Manuscript

- [paper/BOREL_CONJECTURE_PREPRINT.md](paper/BOREL_CONJECTURE_PREPRINT.md)
- [paper/CANONICAL_ROUTING_INDEX.md](paper/CANONICAL_ROUTING_INDEX.md)

## Structure

- `paper/`
  - `BOREL_CONJECTURE_PREPRINT.md`
...
1. Theorem chain first: read `paper/BOREL_CONJECTURE_PREPRINT.md`.
...
Current BOR runner policy:

- `repro/run_repro.sh` extracts, promotes, runs `scripts/bor_closure_guard.py`, updates `repro/repro_manifest.json`, and enforces `fully_extracted` release-gate mode.
...
3. artifact key consumed by `scripts/bor_closure_guard.py`.
...
- Manuscript target: [paper/BOREL_CONJECTURE_PREPRINT.md](paper/BOREL_CONJECTURE_PREPRINT.md)
