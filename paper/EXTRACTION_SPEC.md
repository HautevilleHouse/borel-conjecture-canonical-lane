# Constant Extraction Spec (BOR)
    ...
    ## Formula Set
    - `kappa_rigidity_raw = c_rigid_raw * rigidity_density_raw - e_rigid_raw`
- `sigma_homotopy_raw = homotopy_floor_raw - surgery_loss_raw - restart_loss_raw`
- `kappa_compact_raw = 1.0 / (1.0 + delta_comp_sup_raw)`
- `rho_rigidity_raw = rho_rigidity_raw`
- `homeomorphism_transfer_raw = c_homeo_raw * transfer_gain_raw - e_homeo_raw`
- `eps_coh_raw = eps_coh_raw`
- `sigma_star_can_raw = sigma_star_can_raw`

    ## Validations
    - positivity required for: `kappa_rigidity`, `sigma_homotopy`, `kappa_compact`, `rho_rigidity`, `homeomorphism_transfer`, `sigma_star_can`
    ...
    3. `scripts/bor_closure_guard.py`
