...
mkdir -p .codex_tmp/borel_conjecture
cp artifacts/stitch_constants.json .codex_tmp/borel_conjecture/stitch_constants.json
cp artifacts/constants_registry.json .codex_tmp/borel_conjecture/constants_registry.json
