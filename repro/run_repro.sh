...
mkdir -p .tmp/borel_conjecture
cp artifacts/stitch_constants.json .tmp/borel_conjecture/stitch_constants.json
cp artifacts/constants_registry.json .tmp/borel_conjecture/constants_registry.json
